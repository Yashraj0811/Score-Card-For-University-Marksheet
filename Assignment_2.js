function myFunction(){
    var name=document.validMark.txtname.value;
    document.getElementById("name").innerHTML=name;
    var sem=document.validMark.txtSemester.value;
    document.getElementById("sem").innerHTML=sem;
    var branch=document.validMark.txtBranch.value;
    document.getElementById("branch").innerHTML=branch;
    var rollno=document.validMark.txtRoll.value;
    document.getElementById("rollno").innerHTML=rollno;
    // E-business
    let ebu1=document.validMark.ebu1.value;
    document.getElementById("u1eb").innerHTML=ebu1;
    let ebu2=document.validMark.ebu2.value;
    document.getElementById("u2eb").innerHTML=ebu2;
    let ebfinal=document.validMark.ebfinal.value;
    document.getElementById("finaleb").innerHTML=ebfinal;
    let ebtotal=eval((parseFloat(ebu1=document.validMark.ebu1.value)+parseFloat(ebu2=document.validMark.ebu2.value))/2+parseFloat(ebfinal=document.validMark.ebfinal.value));
    document.getElementById("totaleb").innerHTML=ebtotal;
    let ebavg=eval((parseFloat(ebu1=document.validMark.ebu1.value)+parseFloat(ebu2=document.validMark.ebu2.value))/2);
    document.getElementById("avgeb").innerHTML=ebavg;

    // Internet Programming
    let Ipu1=document.validMark.Ipu1.value;
    document.getElementById("u1ip").innerHTML=Ipu1;
    let Ipu2=document.validMark.Ipu2.value;
    document.getElementById("u2ip").innerHTML=Ipu2;
    let Ipfinal=document.validMark.Ipfinal.value;
    document.getElementById("finalip").innerHTML=Ipfinal;
    let iptotal=eval((parseFloat(document.validMark.Ipu1.value)+parseFloat(document.validMark.Ipu2.value))/2+parseFloat(document.validMark.Ipfinal.value));
    document.getElementById("totalip").innerHTML=iptotal;
    let ipavg=eval((parseFloat(document.validMark.Ipu1.value)+parseFloat(document.validMark.Ipu2.value))/2);
    document.getElementById("avgip").innerHTML=ipavg;
    

    // Software Engineering
    let Seu1=document.validMark.Seu1.value;
    document.getElementById("u1se").innerHTML=Seu1;
    let Seu2=document.validMark.Seu2.value;
    document.getElementById("u2se").innerHTML=Seu2;
    let Sefinal=document.validMark.Sefinal.value;
    document.getElementById("finalse").innerHTML=Sefinal;
    let setotal=eval((parseFloat(document.validMark.Seu1.value)+parseFloat(document.validMark.Seu2.value))/2+parseFloat(document.validMark.Sefinal.value))
    document.getElementById("totalse").innerHTML=setotal;
    let seavg=eval((parseFloat(document.validMark.Seu1.value)+parseFloat(document.validMark.Seu2.value))/2)
    document.getElementById("avgse").innerHTML=seavg;


    // Advance Technology Mnagement
    let Mtu1=document.validMark.Mtu1.value;
    document.getElementById("u1mt").innerHTML=Mtu1;
    let Mtu2=document.validMark.Mtu2.value;
    document.getElementById("u2mt").innerHTML=Mtu2;
    let Mtfinal=document.validMark.Mtfinal.value;
    document.getElementById("finalmt").innerHTML=Mtfinal;
    let mttotal=eval((parseFloat(document.validMark.Mtu1.value)+parseFloat(document.validMark.Mtu1.value))/2+parseFloat(document.validMark.Mtfinal.value));
    document.getElementById("totalmt").innerHTML=mttotal;
    let mtavg=eval((parseFloat(document.validMark.Mtu1.value)+parseFloat(document.validMark.Mtu1.value))/2);
    document.getElementById("avgmt").innerHTML=mtavg;

    // Computer Security Technology
    let Cnu1=document.validMark.Cnu1.value;
    document.getElementById("u1cns").innerHTML=Cnu1;
    let Cnu2=document.validMark.Cnu2.value;
    document.getElementById("u2cns").innerHTML=Cnu2;
    let Cnfinal=document.validMark.Cnfinal.value;
    document.getElementById("finalcns").innerHTML=Cnfinal;
    let cnstotal=eval((parseFloat(document.validMark.Cnu1.value)+parseFloat(document.validMark.Cnu1.value))/2+parseFloat(document.validMark.Cnfinal.value));
    document.getElementById("totalcns").innerHTML=cnstotal;
    let cnsavg=eval((parseFloat(document.validMark.Cnu1.value)+parseFloat(document.validMark.Cnu1.value))/2);
    document.getElementById("avgcns").innerHTML=cnsavg;
